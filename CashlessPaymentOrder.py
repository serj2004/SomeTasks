"""
Заказ с самовывозом и безналичной оплатой
"""
...
class CashlessPaymentOrder(unittest.TestCase):
    def setUp(self):
    ...
    def test_order1(self):
        ...
        driver.find_element(By.XPATH, "//input[@id='edit-customer-profile-billing-"
                                      "field-customer-recepient-email-und-0-value']").send_keys("test@mmm.com")
